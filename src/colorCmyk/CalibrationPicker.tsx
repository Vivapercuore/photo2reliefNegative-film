 ...
 *  Shared by the calibrate page and the CMYK module settings. */
const CalibrationPicker: React.FC<Props> = ({ activeLabel, saved, onApply, onDelete }) => (
  <>
...
export default CalibrationPicker;
